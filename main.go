...
func main() {
	...
	list := widget.NewList(
		...
		func(id widget.ListItemID, obj fyne.CanvasObject) {
			obj.(*widget.Label).SetText(applets[id].name)
		},
	)
